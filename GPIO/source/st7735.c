...
extern void SPI0_write(unsigned char* data, int size);
...
static void ST7735_Select() {
	PTB->PSOR = 0x80;        /* turn reset CS */
}

void ST7735_Unselect() {
	PTB->PCOR = 0x80;        /* turn set CS */  
}

static void ST7735_Reset() {
	PTB->PSOR = 0x100;        /* turn off REST */
	delayMs(5);
	PTB->PCOR = 0x100;        /* turn on REST */
}
